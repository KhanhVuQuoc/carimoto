...
Route::match(['GET', 'POST'], '/customers/Addcompare', [CustomerController::class, 'Get_id_to_compare'])->name('customers.compare');
Route::get( '/customers/compare/delete/{id}', [CustomerController::class, 'Delete_id_from_compare']);
Route::get( '/customers/RenderCompare', [CustomerController::class, 'RenderCompare']);




Route::get('/customers/service', [CustomerController::class, 'show_srevice']);
