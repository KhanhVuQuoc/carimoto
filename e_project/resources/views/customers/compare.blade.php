                                        ...
                                        <tr>
                                            <td class="first-column">Product</td>
                                               ...
                                               <td class="product-image-title">
                                                <a href="#" class="image"><img style="width: 500px; height: 300px;" src="{{$p -> pic}}"   alt="Compare Product"></a>
    ...
    @endforeach
                           ...
                           @endforeach
                                        ...
                                        <tr>
                                            ...
                                            @foreach($products as $p)   
                                             <td class="pro-addtocart"><a href="/customers/compare/delete/{{$p -> id}}" class="add-to-cart" tabindex="0"><span>Delete</span></a></td>
