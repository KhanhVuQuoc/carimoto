    ...
    public function Addcart($id)
{
    ...
    public function RenderCompare(){
        ...
        ->join('customers_products', 'products.id', '=', 'customers_products.compare')
        ->where ('customers_products.customers_id', '=', $id_customer)
        ->groupBy('customers_products.compare','products.id', 'products.name', 'products.price', 'products.description', 'products.pic', 'products.rating', 'products.horse_power', 'products.protection', 'products.promtion', 'products.created_at', 'products.updated_at','customers_products.customers_id','customers_products.products_id','customers_products.quantity')
        
        ->get();
        return view('customers.compare', compact('products')) ;
    }

    public function Delete_id_from_compare($id)
    {
        $id_customer = Session::get('id_customer');
        
            DB::table('customers_products')
                ->where('customers_id', '=', $id_customer)
                ->where('compare', '=', $id)
                ->delete();
    ...
    public function show_srevice()
    {
        
        return view('/customers/srevice') ;
    }
